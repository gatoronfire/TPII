    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            if (N.contains("PUSH")) {
                ...
                // Acá basicamente rompo en 2 el push numero, y creo un subtring con la cadena
                // de numeros
...
class Pila {
    ...
    // funcion push. suma 1 al tope y agrega x en la posicion tope. tambien compara
    // x con el maximo y actualiza el arreglo max
